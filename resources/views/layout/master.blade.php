...
<body>
   ...
   @include('partial.sidebar')
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card" 
     style="
        background: linear-gradient(135deg, #ffffff, #a3dbb0);
        border: none;
        border-radius: 15px;
        box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1);
     ">
          <div class="card-body" style="padding: 30px; color: #155724;">
  ...
  <script src="{{('templating/src/assets/libs/simplebar/dist/simplebar.js')}}"></script>
  <script src="{{asset('templating/src/assets/js/sidebarmenu.js')}}"></script>
  <script src="{{('templating/src/assets/js/app.min.js')}}"></script>
